 ...
 * @ Modified time: 2021-07-18 22:27:57
 * @ Description: Menu
 */
...
const textTnC = () => {
    return `
HameBot adalah *Bot* yg merupakan akronim dari kata Robot yang berarti sebuah sistem yang diprogram oleh komputer.
...
- Tidak memanfaatkan fitur dalamm bot untuk keperluan sekolah.
...
${q3}\\ / ! $ ^ % & + . , - (Untuk fitur ini masih dalam penambahan)${q3}
...
Chat dengan trigger (bot, hame, hamebot) atau tag akan dijawab oleh simsimi.
